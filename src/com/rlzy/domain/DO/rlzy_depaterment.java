...
public class rlzy_depaterment {
	...
	private String staffleave_gmt_modified;
	...
	public String getStaffdepartment_gmt_create() {
		return staffdepartment_gmt_create;
	}
	public void setStaffdepartment_gmt_create(String staffdepartment_gmt_create) {
		this.staffdepartment_gmt_create = staffdepartment_gmt_create;
	}
	public String getStaffleave_gmt_modified() {
		return staffleave_gmt_modified;
	}
	public void setStaffleave_gmt_modified(String staffleave_gmt_modified) {
		this.staffleave_gmt_modified = staffleave_gmt_modified;
	}
