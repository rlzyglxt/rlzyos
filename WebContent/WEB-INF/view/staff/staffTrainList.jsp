...
<script type="text/javascript" src="<%=basePath%>js/staff/staffTrain.js"></script>
								...
								<tbody>
									...
									<!-- 	<td>{{ staffTrain.staffTrain_gmt_modified }}</td> -->
										<td><button onclick="createConfirmUpdata(this)" 
											...
											<button onclick="createConfirmDeleteStaffTrain(this)"
...
<!---------------------update--------------------------------------------修改模态框----------------------------------------------------  -->
	<div class="modal fade" id="updateStaffTrain" tabindex="-1" role="dialog"	aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document" style="width: 389px;">
					...
					<div id="addContent">
						<form id="addstafftrainForm" name="addstafftrainForm">
							<table class="table" style="margin: 0 auto;">
								<tr>
									<td><label>员工工号：</label></td>
									<td><input id="stafftrain_staff" name="stafftrain_staff" oninput="getValue(this)"
								...
								<tr><td><label>证书名称：</label></td>
									<td><input id="addstafftrain_certificate" name="stafftrain_certificate"
										type="text" class="form-control" placeholder="请输入证书名称"></td>
								</tr>
							</table>
						</form>
